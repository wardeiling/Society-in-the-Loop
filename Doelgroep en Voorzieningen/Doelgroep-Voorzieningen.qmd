...
De [Databank](https://utrecht.incijfers.nl/jive) van Utrecht in Cijfers heeft ook informatie over de voorzieningen in de subwijk Zuilen (of de de gehele wijk Noordwest of de buurten van Zuilen). Utrecht in Cijfers is een compilatie van verschillende data bronnen, waaronder ook CBS data. Zo is er bijvoorbeeld informatie over de volgende voorzieningen:
